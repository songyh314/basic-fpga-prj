...
HD_PWD='F:/WORK/prj_fpga/multi/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_line.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_line.tcl
