...
HD_PWD='F:/WORK/prj_fpga/multi/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_line.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_line.tcl -notrace
